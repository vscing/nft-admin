  ...
  return (
    <div className="addList">
      ...
      <Form form={form} className="formItem">
        <Row>
          <Col span={8}>
            <FormItem labelAlign={"left"} name="title" label="商品名称" style={{ width: "100%" }}>
        ...
        <Row>
          <Col span={8}>
            <FormItem labelAlign={"left"} name="total_stock" label="商品预售总数">
            ...
            <FormItem labelAlign={"left"} name="status" label="商品状态">
                    <Select
                      ...
                      >
                          ...
                          <Option key={10} value={10}>待预售</Option>
                          <Option key={20} value={20}>发行中</Option>
                          <Option key={30} value={30}>已售罄</Option>
                    </Select>
            </FormItem>
          </Col>
        </Row>
        <Row>
          <Col span={8}>
            <FormItem labelAlign={"left"} name="presell_time" label="商品预售时间">
        ...
        <Row>
          <Col span={8}>
            <FormItem labelAlign={"left"} name="contract_address" label="合约地址">
        ...
        <Row>
          <Col span={8}>
            <FormItem labelAlign={"left"} name="token_standard" label="认证标准">
